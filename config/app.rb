Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-chat-app.com'
  config.app_name = 'Volt-chat-app'
  config.mailer.from = 'Volt-chat-app <no-reply@volt-chat-app.com>'
  ...
  #
  config.app_secret = 'BqCwQRMX8AqSoKoXC4hCLWb7Ib90ZzEyJtKvWbpC7qGmZV_XHa3dADQd4kC8X88VllY'
